	...
	function checkKeyword(keyword) {
	    var convertOptions = new Array("OBO", "png", "jpg", "gif", "bmp", "ico", "tif", "tga", "svg", "wbmp", "webp", "eps", "exr", "aax", "aiff", "flac", "m4a", "mp3", "ogg", "opus", "wav", "wma", "doc", "docx", "flash", "html", "odt", "pdf", "rtf", "txt", "avi", "mp4", "mov", "wmv", "ogv", "flv", "mkv", "3g2", "3gp", "azw", "azw3", "epub", "fb2", "lit", "lrf", "mobi");
	    ...
	    if (firstWord == "open" || firstWord == "search" || firstWord == "donate") {
	        ...
	        if (secondWord == "this" && thirdWord == "to") {
	            if (checkKeyword(fourthWord)) {
	                ...
	                $('#tableId > tbody').append("<tr><td class=returnField> Not a valid file type to convert to</td></tr>");
	                addNewQueryBox();
	            }
	        } else {
	            noRedirect();
